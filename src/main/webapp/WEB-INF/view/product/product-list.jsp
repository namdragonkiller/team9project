            ...
            <ul class="list-group products">
                <c:forEach items="${lists}" var="list" varStatus="status">
                    <li class="list-group-item d-flex mt-3">
                        ...
                        <div class="col text-center price">${list.price}</div>
                        <div class="col text-end action"><button class="btn btn-small btn-outline-dark">추가</button></div>
                    </li>
                </c:forEach>
            </ul>
        </div>
...
<script src="${pageContext.request.contextPath}/assets/js/product-list.js" defer></script>
